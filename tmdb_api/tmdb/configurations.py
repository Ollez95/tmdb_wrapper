...
from tmdb_api.data.configuration import Configuration, ConfigurationCountry, ConfigurationJobs, ConfigurationLanguage, ConfigurationPrimTranslations, ConfigurationTimezones
